...
class ConjugateGradientSolver {
    companion object {
        ...
        fun getSolve(a0: FractionMatrix, b0: FractionMatrix, x0: FractionMatrix, epsilon: Double): FractionMatrix {
            if (a0.determinant().toDouble() < 0 || a0 != a0.trans()) throw NoSolveException("Doesn't satisfy condition")
